//use picture src chosen from media pick
$(document).on('click','.media_select_ok',function(){
    media_src = $(this).attr('media_src');
    $('.profile_page_picture').attr({'src':media_src});
    $('.profile_page_picture_url').val(media_src);
    media_exit();
})
...
//selecting all users in a page to peform a bulk function
...
//confirm before deleting user(s)
